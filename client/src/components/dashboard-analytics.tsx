...
interface DashboardAnalyticsProps {
  /** Polling en ms (défaut : 5000). Passer 0 pour désactiver. */
  refetchInterval?: number;
}

export function DashboardAnalytics({ refetchInterval = 5000 }: DashboardAnalyticsProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              <span className="text-red-500 font-semibold">{stats.participants.zombies} zombies</span>
              {", "}
              <span className="text-blue-500 font-semibold">{stats.participants.survivors} survivants</span>
            </p>
          </CardContent>
        </Card>
      ...
      {/* Squad Distribution */}
      <Card
        className="relative overflow-hidden bg-gradient-to-br from-purple-500/5 via-background to-background border-t-4 border-t-purple-500"
